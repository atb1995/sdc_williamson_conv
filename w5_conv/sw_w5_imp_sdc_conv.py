...
# I/O
dirname = "williamson_5_imp_sdc_ref%s_dt%s_k%s_deg%s" % (ref_level, dt_true, 1, degree)
...
for dt in dts:
    ...
    for s in scheme_index:
        ...
        # I/O
        dirname = "williamson_5_ref%s_imp_sdc_gif_dt%s_k%s_deg%s" % (ref_level, dt, s, degree)
