...
dts = [  2400., 1800., 1200., 900.,600., 400., 200., 100., 50., 25.]
tmax = 1*day
ndumps = 1
...
# I/O
dirname = "williamson_1_im_true_comp_ref%s_dt%s_deg%s" % (ref_level, dt_true, degree)
...
for dt in dts:
        ...
        for s in scheme_index:
                ...
                # I/O
                dirname = "williamson_1_IM_SDC_comp_ref%s_dt%s_k%s_deg%s" % (ref_level, dt, s, degree)
